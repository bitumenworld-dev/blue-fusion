...
import static com.bitumen.bluefusion.domain.EmployeeAsserts.*;
...
class EmployeeResourceIT {
    ...
    private static final Boolean DEFAULT_CONTRACT_ACTIVE = false;
    private static final Boolean UPDATED_CONTRACT_ACTIVE = true;
    ...
    public static Employee createEntity() {
        return new Employee().employeeId(DEFAULT_EMPLOYEE_ID).contractActive(DEFAULT_CONTRACT_ACTIVE);
    }
    ...
    public static Employee createUpdatedEntity() {
        return new Employee().employeeId(UPDATED_EMPLOYEE_ID).contractActive(UPDATED_CONTRACT_ACTIVE);
    }
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.[*].contractActive").value(hasItem(DEFAULT_CONTRACT_ACTIVE)));
    }
    ...
    void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.contractActive").value(DEFAULT_CONTRACT_ACTIVE));
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.employeeId(UPDATED_EMPLOYEE_ID).contractActive(UPDATED_CONTRACT_ACTIVE);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.employeeId(UPDATED_EMPLOYEE_ID).contractActive(UPDATED_CONTRACT_ACTIVE);
