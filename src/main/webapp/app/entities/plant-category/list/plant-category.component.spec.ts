...
import { sampleWithRequiredData } from '../plant-category.test-samples';
...
describe('PlantCategory Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.plantCategories()[0]).toEqual(expect.objectContaining({ id: 7148 }));
  });

  describe('trackId', () => {
    it('should forward to plantCategoryService', () => {
      const entity = { id: 7148 };
      jest.spyOn(service, 'getPlantCategoryIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPlantCategoryIdentifier).toHaveBeenCalledWith(entity);
