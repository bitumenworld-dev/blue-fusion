...
public class WorkshopIssuanceFuelTransactionHandler extends AbstractFuelTransactionHandler {
    ...
    public void validateFuelTransaction(FuelTransactionRequest fuelTransactionRequest) {
        fuelTransactionValidator.validateWorkshopIssuance(fuelTransactionRequest);
    }
}
